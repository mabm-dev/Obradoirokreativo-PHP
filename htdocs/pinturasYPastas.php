...
?>
   ...
   //resultados por pagina
    ...
    //Se muestran los datos de los Articulos en una tabla HTML
    ...
    if ($result) { //Gesti�n de errores. ?>
        ...
        if ($_SESSION["usuario"] == "Administrador"){?>
            <td><a href="pinturasYPastas.php?pag=<?php echo $pag=1;?>&orden=intID">ID</a></td>
        <?php }} ?>
            <td><a href="pinturasYPastas.php?pag=<?php echo $pag=1;?>&orden=Name">Nombre</a></td>
        <?php if(isset($_SESSION["usuario"])){
        if ($_SESSION["usuario"] == "Administrador"){?>
            <td><a href="pinturasYPastas.php?pag=<?php echo $pag=1;?>&orden=Cost">Coste</a></td>
        <?php }} ?>   
            <td><a href="pinturasYPastas.php?pag=<?php echo $pag=1;?>&orden=Price">Precio</a></td>
                        <td><a href="pinturasYPastas.php?pag=<?php echo $pag=1;?>&orden=Img">Imagen</a></td>
         </tr><?php
            ...
            if ($_SESSION["usuario"] != "Administrador"){?>
             <td><?php  $arti=$row["ArticuloID"]; 
             	...
             	<form class="form-carrito" action="cesta.php" method="post">
                	...
                	<input type="hidden" name="ubi" value="<?php echo "pinturasYPastas";?>">
        ...
        <tr>
            <td>PAGINA:
            	...
            	<a href="pinturasYPastas.php?pag=<?php echo $i;?>&orden=<?php echo $orden;?>"><?php echo $i;?></a>
            	&nbsp;
            	<?php }
            	?>
            </td>
