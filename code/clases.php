    ...
    if ($result) { //Gesti�n de errores. ?>
        ...
        <tr>
            ...
            <form action="FormArticulo.php" method="post" enctype="multipart/form-data">
                ...
                <input type="submit" value="Crear Clase"></input>
            </form><?php }}?>
            </td>
        </tr>
        ...
        if ($_SESSION["usuario"] == "Administrador"){?>    
            <td><a href="clases.php?pag=<?php echo $pag=1;?>&orden=intID">ID</a></td>
        <?php }} ?>    
            <td><a href="clases.php?pag=<?php echo $pag=1;?>&orden=Name">Nombre</a></td>  
            <td><a href="clases.php?pag=<?php echo $pag=1;?>&orden=Price">Precio</a></td>
            <td><a href="clases.php?pag=<?php echo $pag=1;?>&orden=Tematica">Tematica</a></td>
                        <td><a href="clases.php?pag=<?php echo $pag=1;?>&orden=Fecha">Fecha</a></td>
            <td><a href="clases.php?pag=<?php echo $pag=1;?>&orden=Img">Imagen</a></td>
        </tr><?php
    	 ...
    	 <?php }} ?>	
            ...
            <td><?php  $arti=$row["ArticuloID"]; 
             	...
             	<form class="form-carrito" action="cesta.php" method="post">
                	...
                	<input type="hidden" name="ubi" value="<?php echo "clases";?>">
        ...
        <tr>
            <td>PAGINA:
            	...
            	<a href="clases.php?pag=<?php echo $i;?>&orden=<?php echo $orden;?>"><?php echo $i;?></a>
            	&nbsp;
            	<?php }
            	?>
            </td>
