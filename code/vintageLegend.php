...
?>
    ...
    //Mostramos en pantalla el numero de Pagina(solo arreglos internos).
    //echo "Pag: " . $pag . "<br>";
    ...
    if ($result) { //Gesti�n de errores. ?>
        ...
        <tr>
            ...
            <form action="FormArticulo.php" method="post" enctype="multipart/form-data">
                <input name="id" type="hidden" value="<?php echo $numArticulosTotal+1;?>"></input>
                <input name="intid" type="hidden" value="<?php echo $numArticulos+1;?>">
                <input name="Category" type="hidden" value="<?php echo $Categoria;?>">
                <input name="action" type="hidden" value="crearArticulo"></input>
        ...
        if ($_SESSION["usuario"] == "Administrador"){?>
            <td><a href="vintageLegend.php?pag=<?php echo $pag=1;?>&orden=intID">ID</a></td>
        <?php }} ?>    
            <td><a href="vintageLegend.php?pag=<?php echo $pag=1;?>&orden=Name">Nombre</a></td>
        <?php if(isset($_SESSION["usuario"])){
        if ($_SESSION["usuario"] == "Administrador"){?>    
            <td><a href="vintageLegend.php?pag=<?php echo $pag=1;?>&orden=Cost">Coste</a></td>
        <?php }} ?>    
            <td><a href="vintageLegend.php?pag=<?php echo $pag=1;?>&orden=Price">Precio</a></td>
                        <td><a href="vintageLegend.php?pag=<?php echo $pag=1;?>&orden=Img">Imagen</a></td>
        </tr><?php
    	...
    	<?php }} ?>	
    		...
    		<td>
            	<form action="FormArticulo.php" method="post" enctype="multipart/form-data">
            	    <input name="id" type="hidden" value="<?php echo $row["ArticuloID"];?>"></input>
            ...
            <td><?php  $arti=$row["ArticuloID"];
             	...
             	<form class="form-carrito" action="cesta.php" method="post">
                	...
                	<input type="hidden" name="ubi" value="<?php echo "vintageLegend";?>">
        ...
        <tr>
            <td>PAGINA:
            	...
            	<a href="vintageLegend.php?pag=<?php echo $i;?>&orden=<?php echo $orden;?>"><?php echo $i;?></a>
            	&nbsp;
            	<?php }
            	?>
            </td>
