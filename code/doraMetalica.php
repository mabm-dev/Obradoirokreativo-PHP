...
?>
    ...
    //echo "Pag: " . $pag . "<br>";
    //Guardamos en una variable el numero de Articulos de la tabla
    ...
    if ($result) { //Gesti�n de errores. ?>
        ...
        if ($_SESSION["usuario"] == "Administrador"){?>
            <td><a href="doraMetalica.php?pag=<?php echo $pag=1;?>&orden=intID">ID</a></td>
        <?php }} ?>    
            <td><a href="doraMetalica.php?pag=<?php echo $pag=1;?>&orden=Name">Nombre</a></td>
        <?php if(isset($_SESSION["usuario"])){
        if ($_SESSION["usuario"] == "Administrador"){?>    
            <td><a href="doraMetalica.php?pag=<?php echo $pag=1;?>&orden=Cost">Coste</a></td>
        <?php }} ?>    
            <td><a href="doraMetalica.php?pag=<?php echo $pag=1;?>&orden=Price">Precio</a></td>
                        <td><a href="doraMetalica.php?pag=<?php echo $pag=1;?>&orden=Img">Imagen</a></td>
        </tr><?php
    	...
    	<?php }} ?>	
    		<td><?php echo $row["Price"]. " &euro;";?></td>
    		    		<td><img class="imagenes" class="hola" src="data:image/jpg;base64,<?php echo base64_encode($row["Img"]);?>"></td>
    		<?php 
    		if(isset($_SESSION["usuario"])){
    		if ($_SESSION["usuario"] == "Administrador"){?>
    		<td>
            ...
            <td><?php  $arti=$row["ArticuloID"];
             	...
             	<form class="form-carrito" action="cesta.php" method="post">
                	...
                	<input type="hidden" name="ubi" value="<?php echo "doraMetalica";?>">
        ...
        <tr>
            <td>PAGINA:
            	...
            	<a href="doraMetalica.php?pag=<?php echo $i;?>&orden=<?php echo $orden;?>"><?php echo $i;?></a>
            	&nbsp;
            	<?php }
            	?>
            </td>
